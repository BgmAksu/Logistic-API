...
down_revision: Union[str, Sequence[str], None] = '56a099ce5a9b'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('CREATED', 'IN_TRANSIT', 'DELIVERED', name='shipment_status'), nullable=False),
    ...
    op.create_index('ix_parcels_shipment_barcode', 'parcels', ['shipment_id', 'barcode'], unique=True)
